...
router.patch('/:id/reopen-selection', verifyToken, requireMembershipCommittee, reopenSelection)
router.patch('/:id/confirm',     verifyToken, confirm)
router.patch('/:id/complete',    verifyToken, requireMembershipCommittee, complete)
...
router.patch('/:id/reject',      verifyToken, requireMembershipCommittee, reject)
