const UserCaseLogsModel = require('../models/user_case_logs.model')

const getItems = async (req, res) => {
    try {
        const data = await UserCaseLogsModel.getAll()
        res.json(data)
    } catch (err) {
...
const createItem = async (req, res) => {
    try {
        ...
        const item = await UserCaseLogsModel.create(req.body)
