        ...
        <table className={styles.table}>
          <thead>
            <tr className={styles.headerRow}>
              ...
              <th className={`${styles.th} ${styles.sortableTh}`} onClick={() => onSort && onSort("user_id")}>
                User ID {renderSortIcon("user_id")}
              </th>
              <th className={`${styles.th} ${styles.sortableTh}`} onClick={() => onSort && onSort("name")}>
                Name {renderSortIcon("name")}
              </th>
              <th className={`${styles.th} ${styles.sortableTh}`} onClick={() => onSort && onSort("status")}>
                Status {renderSortIcon("status")}
              </th>
              <th className={`${styles.th} ${styles.sortableTh}`} onClick={() => onSort && onSort("role")}>
                Role {renderSortIcon("role")}
              </th>
              {showCommittee && <th className={styles.th}>Committee</th>}
              <th className={`${styles.th} ${styles.sortableTh}`} onClick={() => onSort && onSort("dateCreated")}>
