...
// ─── DateRangeDropdown ────────────────────────────────────────────────────────
// FIX: Extracted into its own top-level component so that hooks are never called
// conditionally. Previously, useState was called inside an `if` block inside
// DefaultFilterDropdown, which violates the Rules of Hooks and broke the
// entire FilterMenu render.
...
// ─── SelectDropdown ───────────────────────────────────────────────────────────
// FIX: Extracted into its own top-level component (previously the `else` branch
// of DefaultFilterDropdown which called hooks conditionally).
...
// Now a simple router — no hooks of its own — delegates to the correct
// component based on field type. This eliminates the conditional-hook bug.
