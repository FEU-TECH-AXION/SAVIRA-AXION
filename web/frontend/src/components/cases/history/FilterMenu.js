...
function DefaultFilterDropdown({ field, value, onChange, officerOptions = FALLBACK_OFFICERS_LIST }) {
    ...
    <div className={styles.filterBarWrap}>
      ...
      <div className={styles.searchWrap}>
        <input
          ...
          type="text"
          placeholder="Search by Case ID, description, assigned personnel, status, or city..."
          value={searchValue}
