const LegalPersonnelsModel = require('../models/legal_personnels.model')

const getItems = async (req, res) => {
    try {
        const data = await LegalPersonnelsModel.getAll()
        res.json(data)
    } catch (err) {
...
const createItem = async (req, res) => {
    try {
        ...
        const item = await LegalPersonnelsModel.create(req.body)
